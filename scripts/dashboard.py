...
def _load_workers_state():
    ...
    _BACKEND_KEY_MAP = {
        ...
        ("dashscope",  "qwen3.6-plus-2026-04-02"):        "dashscope-qwen36-plus",
        ("dashscope",  "qwen3.5-27b"):                    "dashscope-qwen35-27b",
        ("dashscope",  "glm-5"):                          "dashscope-glm5",
        ("dashscope",  "qwen3.5-122b-a10b"):              "dashscope-qwen35-122b",
        ("dashscope",  "qwen3.5-35b-a3b"):                "dashscope-qwen35-35b",
        ("dashscope",  "qwen3.5-plus-2026-02-15"):        "dashscope-qwen35-plus-0215",
        ("dashscope",  "kimi-k2.5"):                      "dashscope-kimi-k25",
        ("dashscope",  "MiniMax-M2.1"):                   "dashscope-minimax-m21",
