...
export const manifest = [
  ...
  "content/sutras/dashizhi-yuantong.md",
  "content/sutras/bushi-sutra.md",
  "content/sutras/liaozhiping-sutra.md",
  "content/sutras/famiejin-sutra.md",
  "content/sutras/guanyin-ergen-yuantong.md",
];
...
export const documentIndex = [
  ...
  },
  {
    ...
    volume_label: "楞严经卷五节录",
    translation_status: "translated",
    review_status: "unreviewed",
    updated_at: "2026-03-28",
    summary: "出自《楞严经》卷五，大势至菩萨自述以念佛心入无生忍，都摄六根、净念相继，为净土宗重要经典。",
    tags: ["净土", "念佛", "楞严", "短经"],
    translated_by: "claude-opus-4-6",
    path: "content/sutras/dashizhi-yuantong.md",
  },
  {
    title: "佛说布施经",
    short_title: "布施经",
    ...
    review_status: "unreviewed",
    updated_at: "2026-03-28",
    summary: "宋法贤译，佛为大苾刍众说三十七种布施法及其果报，并为舍卫国王开示真布施与十善行施之道。",
    tags: ["布施", "福报", "短经"],
    translated_by: "claude-opus-4-6",
    path: "content/sutras/bushi-sutra.md",
  },
  {
    title: "佛说疗痔病经",
    short_title: "疗痔病经",
    ...
    review_status: "unreviewed",
    updated_at: "2026-03-28",
    summary: "唐义净译，佛为阿难陀说疗治痔病之陀罗尼咒及雪山难胜华譬喻，为佛教治病经典之一。",
    tags: ["陀罗尼", "治病", "短经"],
    translated_by: "claude-opus-4-6",
    path: "content/sutras/liaozhiping-sutra.md",
  },
  {
    title: "佛说法灭尽经",
    short_title: "法灭尽经",
    ...
    review_status: "unreviewed",
    updated_at: "2026-03-28",
    summary: "失译人名，佛临涅槃时预言末法时代正法衰灭的种种景象，以及弥勒下生成佛的未来。",
    tags: ["末法", "预言", "涅槃"],
    translated_by: "claude-opus-4-6",
    path: "content/sutras/famiejin-sutra.md",
  },
  {
    title: "观世音菩萨耳根圆通章",
    short_title: "耳根圆通章",
    slug: "guanyin-ergen-yuantong",
    volume_label: "楞严经卷六节录",
    translation_status: "translated",
    review_status: "unreviewed",
    updated_at: "2026-03-28",
    summary: "出自《楞严经》卷六，观世音菩萨自述从闻思修入三摩地的修行法门，含三十二应身、十四无畏、四不思议妙德，以及文殊拣选耳根圆通为最胜法门。",
    tags: ["观音", "楞严", "圆通", "耳根"],
    translated_by: "claude-opus-4-6",
    path: "content/sutras/guanyin-ergen-yuantong.md",
  },
];
...
export async function loadDocument(path) {
  ...
  if (!response.ok) {
    throw new Error(`无法读取 ${path} (Status: ${response.status})`);
  }
