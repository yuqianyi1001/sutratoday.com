...
export const manifest = [
  ...
  "content/sutras/larger-sukhavati-vyuha-lower.md",
];
...
export const documentIndex = [
  ...
  },
  {
    ...
    tags: ["地藏", "愿力", "孝道"],
    path: "content/sutras/ksitigarbha-vow-sutra-upper.md",
  ...
  },
  {
    ...
    tags: ["地藏", "愿力", "存亡"],
    path: "content/sutras/ksitigarbha-vow-sutra-lower.md",
    work_id: "ksitigarbha-vow-sutra",
    work_title: "地藏菩萨本愿经",
    work_short_title: "地藏经",
    work_summary: "《地藏菩萨本愿经》两卷围绕地藏菩萨大愿、因果业报、临终救拔与见闻利益展开，兼明孝亲、修福、称名与救苦之道。",
  ...
  },
  {
    ...
    tags: ["净土", "无量寿", "愿海"],
    path: "content/sutras/larger-sukhavati-vyuha-upper.md",
  ...
  },
  {
    ...
    tags: ["净土", "无量寿", "愿海"],
    path: "content/sutras/larger-sukhavati-vyuha-lower.md",
    work_id: "larger-sukhavati-vyuha",
    work_title: "佛说无量寿经",
    work_short_title: "无量寿经",
    work_summary: "《佛说无量寿经》两卷围绕法藏比丘成就净土、三辈往生、五恶五善对治、胎化差别与闻名得益展开，是净土系根本长经。",
